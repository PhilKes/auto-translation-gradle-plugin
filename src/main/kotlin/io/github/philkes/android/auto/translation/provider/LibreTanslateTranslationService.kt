...
class LibreTanslateTranslationService(private val client: LibreTranslateClient) : TranslationService() {
    ...
    override fun translateBatch(
        ...
        return texts.map {
            client.translate(it, sourceLanguage, targetLanguage).translatedText
        }
    }
}
